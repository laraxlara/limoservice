      ...
      <div className='services-container'>
        ...
        <div className='service-content-wrapper'>
          <div className='service-content-header'>
            <h1>Executive <span>Limo Service</span></h1>
          ...
          <div className='service-content'>
            ...
            <div className='service-page-down'>
              <h3>TRANSFERS STARTING AT ONLY <span>74.99 $</span></h3>
              <div className='service-page-h5'>
                <h5><span>&#x2611;</span> PROFESSIONAL DRIVERS</h5>
                <h5><span>&#x2611;</span> LUXURY LIMOS</h5>
                <h5><span>&#x2611;</span> BEST RATES</h5>
                <h5><span>&#x2611;</span> EASY ONLINE BOOKING </h5>
              </div>
              <h4>CALL US <i><AiOutlinePhone /></i><a href='/'>+1 305-570-2684</a> <br/> OR <br/> BOOK NOW BY FILLING OUT THE FORM</h4>
            </div>
        </div>
        </div>
        ...
        <div className='service-right'>
            ...
            <Card style={{ width: '22rem' }}>
                <Card.Body>
                    ...
                    <Card.Subtitle className="mb-2 text-muted">Read Only On Our Blog</Card.Subtitle>
                    <Card.Text>With the Uber service, you never know which vehicle is going to pick you up, is it clean, is it spacious and there is always the possibility for the driver to cancel the ride. Limo service allows you to choose what type of vehicle you want , it is always perfectly clean with a bottle of cold water...</Card.Text>
