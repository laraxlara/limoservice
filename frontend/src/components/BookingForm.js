              ...
              <div className="controls">
                <div className="row">
                  <div className="col-md-12">
                    <p>
                      Fill out this form and we will contact you soon afterward
                    </p>
                  ...
                  <div className="col-md-12">
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        placeholder="Please enter your pick up location adress or point of interest *"
                  ...
                  <div className="col-md-12">
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        value={dropOfAdress}
                        className="form-control"
                        placeholder="Please enter your drop off location adress or point of interest *"
                        data-error="Lastname is required."
                        onChange={e => setDropOfAdress(e.target.value)}
                      />
                    </Form.Group>
                  </div>
                </div>
                  ...
                  <div className="col-md-12">
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        value={message}
                        className="form-control"
                        placeholder="*Do you have any special requests? *Will there be any stops? How many? *Do you want us to provide special food or drink for your ride? *For what type of special occassion do you need the ride?"
                        rows="6"
